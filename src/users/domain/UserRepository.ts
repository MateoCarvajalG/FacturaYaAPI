...
export interface UserRepository{
  ...
  updateUserByid(document: UserDocument,update:Omit<User,'document'>):Promise<Nullable<UserObject>>
  removerUserByDocument(document:UserDocument):Promise<Nullable<UserObject>>
}
